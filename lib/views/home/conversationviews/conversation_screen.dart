...
class ConversationView extends StatefulWidget {
  ...
  ConversationView({required this.chatRoomId, required this.name});
      ...
      builder: (context,snapshot){
        return ListView.builder(
          ...
          itemBuilder: (context, index){
            return snapshot.hasData?ChatTile(
              message: (snapshot.data as QuerySnapshot).docs[index].get('message'),
              isSendbyMe: (snapshot.data as QuerySnapshot).docs[index].get('sentBy')==Constants.myName,)
                :Container();
          },
        );
      },
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.black12,
        centerTitle: true,
        title: Text(widget.name,style: simpleTextStyle,),
      ),
                            ...
                            child: Container(
                              ...
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                    isDense: true,
                                    contentPadding: EdgeInsets.fromLTRB(15, 10, 5.0, 10),
                                    filled: true,
